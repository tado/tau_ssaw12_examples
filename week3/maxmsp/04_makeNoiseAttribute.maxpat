{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 10.0, 51.0, 551.0, 428.0 ],
		"bglocked" : 0,
		"defrect" : [ 10.0, 51.0, 551.0, 428.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.brcosa @brightness 1.5 @contrast 0.3 @saturation 3.",
					"numinlets" : 1,
					"numoutlets" : 2,
					"id" : "obj-2",
					"fontname" : "Geneva",
					"patching_rect" : [ 105.0, 180.0, 339.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-9",
					"fontname" : "Geneva",
					"patching_rect" : [ 420.0, 315.0, 86.0, 21.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-11",
					"fontname" : "Geneva",
					"patching_rect" : [ 300.0, 345.0, 138.0, 23.0 ],
					"outlettype" : [ "bang", "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-12",
					"fontname" : "Geneva",
					"patching_rect" : [ 315.0, 315.0, 91.0, 21.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-13",
					"fontname" : "Geneva",
					"patching_rect" : [ 315.0, 255.0, 48.0, 23.0 ],
					"outlettype" : [ "bang", "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-14",
					"fontname" : "Geneva",
					"patching_rect" : [ 315.0, 225.0, 49.0, 23.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 429.5, 340.0, 309.5, 340.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 324.5, 340.0, 309.5, 340.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 324.5, 311.5, 429.5, 311.5 ]
				}
