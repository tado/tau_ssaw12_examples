{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ -1.0, 44.0, 640.0, 480.0 ],
		"bglocked" : 0,
		"defrect" : [ -1.0, 44.0, 640.0, 480.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 195.0, 60.0, 125.0, 22.0 ],
					"id" : "obj-14",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 14.999999, 29.999998, 65.0, 24.0 ],
					"id" : "obj-12",
					"fontname" : "Hiragino Kaku Gothic ProN W3",
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 135.0, 240.0, 91.0, 24.0 ],
					"id" : "obj-9",
					"fontname" : "Hiragino Kaku Gothic ProN W3",
					"numoutlets" : 2,
					"outlettype" : [ "", "" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 135.0, 210.0, 118.0, 24.0 ],
					"id" : "obj-8",
					"fontname" : "Hiragino Kaku Gothic ProN W3",
					"numoutlets" : 2,
					"outlettype" : [ "", "" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 14.999999, 210.0, 113.0, 24.0 ],
					"id" : "obj-7",
					"fontname" : "Hiragino Kaku Gothic ProN W3",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 14.999999, 60.0, 75.0, 22.0 ],
					"id" : "obj-3",
					"fontname" : "Hiragino Kaku Gothic ProN W3",
					"numoutlets" : 1,
					"outlettype" : [ "" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 14.999999, 105.0, 82.0, 24.0 ],
					"id" : "obj-2",
					"fontname" : "Hiragino Kaku Gothic ProN W3",
					"numoutlets" : 2,
					"outlettype" : [ "", "" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 14.999999, 150.0, 81.885712, 24.0 ],
					"id" : "obj-1",
					"fontname" : "Hiragino Kaku Gothic ProN W3",
					"numoutlets" : 1,
					"outlettype" : [ "" ]
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 144.5, 273.0, 334.902588, 273.0, 334.902588, 20.0, 204.5, 20.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 24.5, 56.5, 114.5, 56.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 114.5, 88.519478, 24.5, 88.519478 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 24.5, 198.668823, 144.5, 198.668823 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 1 ],
					"hidden" : 0,
					"midpoints" : [ 24.5, 184.305206, 108.071426, 184.305206, 108.071426, 96.792206, 87.5, 96.792206 ]
				}
